...
#ifndef __STM32_POGO_V3_H__
#define __STM32_POGO_V3_H__
...
#define STM32_FW_APP_CFG_OFFSET_L0			0x00C0
#define STM32_FW_APP_CFG_OFFSET_G0			0x00BC
#define STM32_FW_OFFSET_MODEL_DEFINE_VALUE		0x20
...
#define STM32_BOOT_I2C_WAIT_RESP_POLL_RETRY		\
		(STM32_BOOT_I2C_WAIT_RESP_POLL_TMOUT / STM32_BOOT_I2C_WAIT_RESP_POLL_INTVL)
...
#define STM32_BOOT_I2C_MAX_ERASE_PARAM_LEN		(4096) /* In case of erase parameter with 2048 pages */
 /* Larger one between write and erase., */
#define STM32_BOOT_I2C_MAX_PAYLOAD_LEN			(STM32_BOOT_I2C_MAX_ERASE_PARAM_LEN)

#define STM32_BOOT_I2C_REQ_CMD_LEN			\
		(STM32_BOOT_I2C_CMD_LEN + STM32_BOOT_I2C_CHECKSUM_LEN)
#define STM32_BOOT_I2C_REQ_ADDRESS_LEN			\
		(STM32_BOOT_I2C_ADDRESS_LEN + STM32_BOOT_I2C_CHECKSUM_LEN)
#define STM32_BOOT_I2C_READ_PARAM_LEN			\
		(STM32_BOOT_I2C_NUM_READ_LEN + STM32_BOOT_I2C_CHECKSUM_LEN)
#define STM32_BOOT_I2C_WRITE_PARAM_LEN(len)		\
		(STM32_BOOT_I2C_NUM_WRITE_LEN + len + STM32_BOOT_I2C_CHECKSUM_LEN)
#define STM32_BOOT_I2C_ERASE_PARAM_LEN(len)		\
		(len + STM32_BOOT_I2C_CHECKSUM_LEN)
...
/* for booster */
#define KDB_SUPPORT_MODEL_CNT				10

#define KDB_MAX77816B_STATUS				0x01
#define KDB_MAX77816B_CONFIG1				0x02
#define KDB_MAX77816B_CONFIG2				0x03
#define KDB_MAX77816B_VOLTAGE				0x04

#define KBD_MAX77816_VOLTAGE_DEFAULT_IC			330000
#define KBD_MAX77816_VOLTAGE_DEFAULT_BOOSTER		500000
#define KBD_MAX77816_VOLTAGE_MIN			260000
#define KBD_MAX77816_VOLTAGE_MAX			514000
#define KBD_MAX77816_VOLTAGE_1STEP			2000

#define KBD_MAX77816_VOL_TO_REG(x)			\
		((((x)-KBD_MAX77816_VOLTAGE_MIN) / KBD_MAX77816_VOLTAGE_1STEP))
#define KBD_MAX77816_REG_TO_VOL(x)			\
		((x * KBD_MAX77816_VOLTAGE_1STEP + KBD_MAX77816_VOLTAGE_MIN))

#define STM32_DEV_FW_UPDATE_PACKET_SIZE			(256)
#define STM32_KEYBOARD_FW_SIZE				(100 * 1024) /* 100 KB */

#define STM32_KEYBOARD_ROW_DATA_MODEL			0x01

#define IS_SEC_ERROR(x)					(x == SEC_ERROR)
...
struct stm32_dev {
	...
	struct wakeup_source *stm32_ws;
#if IS_ENABLED(CONFIG_PM)
	struct completion resume_done;
	bool irq_wake;
	struct work_struct irq_work;
	struct workqueue_struct *irq_workqueue;
	struct work_struct conn_irq_work;
	struct workqueue_struct *conn_irq_workqueue;
#endif
...
#endif
	struct notifier_block keyboard_input_nb;
	...
	struct work_struct notify_flip_work;
	atomic_t check_ic_flag;
	atomic_t check_conn_flag;
	...
	enum stm32_bus_vote voting_flag;
#endif

#if IS_ENABLED(CONFIG_INTERCONNECT)
	u32 stm32_register_ddr;
	struct icc_path *stm32_icc_data;
	enum stm32_bus_vote voting_flag;
#endif
	u8 *sec_pogo_keyboard_fw;
	size_t sec_pogo_keyboard_size;
	u8 read_write_buf[STM32_DEV_FW_UPDATE_PACKET_SIZE];
};
...
extern int boot_module_id;
extern enum pogo_notifier_id_t pogo_notifier_id;
...
extern int stm32_caps_led_value;
...
void stm32_keyboard_connect(struct stm32_dev *data);
